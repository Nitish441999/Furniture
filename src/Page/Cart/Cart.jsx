          ...
          <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            ...
            <div class="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
              <div class="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
                <div class="space-y-6">
                  <div class="rounded-lg border border-gray-200 bg-[#F9F1E7] p-4 shadow-md dark:border-gray-700 dark:bg-gray-800 md:p-6">
              ...
              <div class="mx-auto mt-6 max-w-4xl flex-1 space-y-6 lg:mt-0 lg:w-full">
                <div class="space-y-4 rounded-lg border border-gray-200  p-4 shadow-md dark:border-gray-700 dark:bg-gray-800 sm:p-6 bg-[#F9F1E7] ">
                  ...
                  <a href="#" class="flex w-full items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 text-black">Proceed to Checkout</a>

                  <div class="flex items-center justify-center gap-2">
                    
                    <a href="#" title="" class="inline-flex items-center gap-2 text-sm font-medium text-primary-700 hover:no-underline dark:text-primary-500 border-2 py-2 px-3 border-[#B88E2F] rounded-md hover:bg-[#B88E2F] hover:text-white">
                      Continue Shopping
